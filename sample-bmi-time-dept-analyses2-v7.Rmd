---
title: "Pooled analyses for BMI HR by menopause status subsetted to women not reporting HRT at baseline"
...
load(file="bmidat-pamm-v7.RData") # df.ped from sample-bmi-time-dept-datahandling.Rmd
...
tab.cohorts.in.v7 = with(df.ped, table(cohort.f))
cohorts.in.v7 = names(tab.cohorts.in.v7[tab.cohorts.in.v7>0])
cohorts.in.v7
save(cohorts.in.v7, file="v7-cohorts.RData")
