---
title: "Pooled analyses for BMI HR by menopause status. run unadjusted for cohorts in v6 file"
...
<!-- NOTE: take cohorts from sample-bmi-time-dept-analyses2-v6.Rmd file in sample-bmi-time-dept-analyses2-v6.Rmd and run unadjusted analyses for these cohorts only. -->
...
# cohorts from sample-bmi-time-dept-analyses2-v6.Rmd
load(file="v6-cohorts.RData") # cohorts.in.v6 object
...
df.ped = df.ped[which(df.ped$cohort.f %in% cohorts.in.v6),]
